...
struct DishCellView: View {
    ...
    var body: some View {
        VStack(spacing: 5.dvs) {
            ZStack {
                Color(uiColor: .EATME.LightGray)
                    .cornerRadius(10.dhs)
                    .frame(width: 109.dhs, height: 109.dhs)
                KFImage(URL(string: imageURL))
                    .resizable()
                    .frame(width: 87.dhs, height: 87.dhs)
            }
            Text(name)
