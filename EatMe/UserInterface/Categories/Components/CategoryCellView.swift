...
struct CategoryCellView: View {
    ...
    var body: some View {
        ZStack {
            ...
            HStack {
                VStack {
                    Text(name)
                        .padding(.top, 12.dvs)
                        .font(Font.SFProDisplay.Medium.size(of: 20.dfs))
                        .lineLimit(2)
                        .frame(width: 191.dhs, alignment: .leading)
                    Spacer()
                }
        ...
        .frame(width: 343.dhs, height: 148.dvs)
    }
}
